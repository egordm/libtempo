...
tempogram_wrapper::novelty_curve_to_tempogram_dft(pyarr_d novelty_curve_np, pyarr_d bpm_np, double feature_rate,
...
py::array tempogram_wrapper::normalize_feature(pyarr_cd &feature_np, unsigned int p, double threshold) {
