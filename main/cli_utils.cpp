...
void parse_arguments(Settings &settings, int argc, char **argv, bool &exit, bool &error) {
    ...
    arguments.push_back(new SettingArg<int>(basic_args, "smooth_length", SMOOTH_LENGTH_DESC, {"smooth_length"}, settings.smooth_length));
    ...
    arguments.push_back(new SettingArg<int>(basic_args, "min_section_length", MIN_SECTION_LENGTH_DESC, {"min_section_length"}, settings.min_section_length));
    arguments.push_back(new SettingArg<int>(basic_args, "max_section_length", MAX_SECTION_LENGTH_DESC, {"max_section_length"}, settings.max_section_length));
