...
cx_mat libtempo::normalize_feature(const cx_mat &feature, unsigned int p, double threshold) {
...
vec libtempo::novelty_smoothed_subtraction(const vec &novelty_curve, int sr, int hop_length) {
