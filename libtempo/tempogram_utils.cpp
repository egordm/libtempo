...
vec libtempo::tempogram_utils::extract_confidence(const mat &tempogram, const bool &rollover) {
...
mat libtempo::tempogram_utils::tempogram_apply_window(const mat &tempogram, const vec &window) {
...
mat libtempo::tempogram_utils::tempogram_include_triplets(const mat &tempogram, const vec &axis_lut, float weight) {
...
mat libtempo::tempogram_utils::smoothen_tempogram(const mat &tempogram, const vec &axis_lut, int temporal_unit_size,
...
vec libtempo::tempogram_utils::extract_tempo_curve(const mat &tempogram, const vec &axis_lut) {
    return max_bucket(tempogram, axis_lut);
}

double libtempo::tempogram_utils::bpm_to_cyclic(double bpm, double ref_tempo) {
